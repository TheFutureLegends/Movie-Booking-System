...
public class PaymentController {
    ...
    public String menuAdmin(@RequestParam("userId")int userId, Model userModel, @RequestParam("movieId")int movieId, Model movieModel){
    ...
    public String userSaveReservation(@RequestParam("userId")int userId, Model userModel, Model theModel, @RequestParam("movieName")String movieName, HttpServletResponse response) throws IOException {
    ...
    public String userCreditCardReservation(Integer userId, Model userModel, Model theModel, String movieName, HttpServletResponse response, String userNameKeyword, String cardNumberKeyword, Integer monthKeyword, Integer yearKeyword, String cvvKeyword) throws IOException {
    ...
    public String adminSaveReservation(@RequestParam("userId")int userId, Model userModel, Model theModel, @RequestParam("movieName")String movieName, HttpServletResponse response) throws IOException {
    ...
    @RequestMapping("/adminCreditCard")
    public String adminCreditCardReservation(Integer userId, Model userModel, Model theModel, String movieName, HttpServletResponse response, String userNameKeyword, String cardNumberKeyword, Integer monthKeyword, Integer yearKeyword, String cvvKeyword) throws IOException {
